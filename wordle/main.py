...
# --------------------------------------------------------------------------------------------------------
# Ouverture d'un fichier de mots en anglais pour avoir une base de travail, on a 1379 mots de 5 lettres
# On a fait le tri des mots de 5 lettres parmi tous les mots par l'opération suivante, une fois pour toute
# La liste des mots initiale a été trouvée à l'adresse https://www.mit.edu/~ecprice/wordlist.10000
...
# with open("wordlist_5_letters.txt", "w") as words:
#     for word in WORDS:
#         words.write(word+"\n")
# --------------------------------------------------------------------------------------------------------
